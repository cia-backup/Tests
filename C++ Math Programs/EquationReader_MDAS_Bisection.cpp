...
double FindVariableBisection(string number, int lowerBound, int upperBound)
{
...
int main()
{
    ...
    {
        if((number[x] == 'x') && ((number[x - 1] != 'e') || (number[x + 1] != 'p')))
        {
            unknown = 1;
            break;
        }
    ...
    */
    ...
    variable = FindVariableBisection(number, 0, number.length() - 1);
